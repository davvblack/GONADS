...
GONADS.TILES = EOC({
    ...
    WOOD:       EOC({img_class:"wood",      variants:1, id:2, pathing:4}),
    STONE:      EOC({img_class:"stone",      variants:1, id:3, pathing:6}),
    METAL:      EOC({img_class:"metal",      variants:1, id:4, pathing:8}),
